        ...
        <div className="collapse navbar-collapse align-center pb-3 pb-lg-0" id="navbarText">
          <ul className="navbar-nav ml-auto pr-3">
            <li className="nav-item px-3 py-2 my-auto">
              <Link className="nav-link text-center" to="/recipes" style={{fontSize: "18px", color: "var(--mainGreen)", opacity: "0.8"}} onClick={handleHide}>Բաղադրատոմսեր</Link>
            </li>
            <li className="nav-item px-3 py-2 my-auto">
              <Link className="nav-link text-center" to="/advices" style={{fontSize: "18px", color: "var(--mainGreen)", opacity: "0.8"}} onClick={handleHide}>Խորհուրդներ</Link>
            </li>
            <li className="nav-item px-3 py-2 my-auto">
              <Link className="nav-link text-center" to="/shop" style={{fontSize: "18px", color: "var(--mainGreen)", opacity: "0.8"}} onClick={handleHide}>Խանութ</Link>
            </li>
            <li className="nav-item pl-lg-3 py-2 my-auto">
              <Link className="nav-link text-center" to="/login" style={{fontSize: "18px", color: "var(--mainGreen)", opacity: "0.8"}} onClick={handleHide}>Մուտք</Link>
            </li>
